...
And I save CRF
	...
	And I verify new queries did not fire on "Assessment Date 1" and "Numeric Field 2" fields
	And I take screenshot
    When I run SQL Script "Query Logging Script.sql"  #Question: Should we see it in logs for Patch 11?
    Then I shoud see SQL result 
      |ProjectName        |SiteNumber  |SiteName          |Environment |SubjectName  |CheckActionInstanceName     |CheckActionInstanceDataPageName |CheckActionRecordPosition |CheckActionFieldName |CheckActionFieldData |TriggerFieldInstanceName |TriggerFieldInstanceDatapageName |TriggerFieldRecordPosition |TriggerFieldName        |TriggerFieldData |EditCheckName                            |MarkingGroupName |QueryMessage                                  |EventTime  |
...
And I save CRF
	    ...
	    |Numeric Field 1   |100         |
	    |Numeric Field 2   |101         |
	And I verify Field "Assessment Date 2" displays Query with Requires Response
	And I verify Field "Numeric Field 2" displays Query with Requires Response
	And I take screenshot
...
And I save CRF
	...
	And I answer the Query on Field "Assessment Date 2, Numeric Field 2"
	And I save CRF
	And I take screenshot
	And I verify the queries did not fire on "Assessment Date 2" and "Numeric Field 2" fields
	And I take screenshot
...
And I save CRF
	    ...
	    |Numeric Field 1         |100         |
	    |Numeric Field 2         |101         |	
	And I verify Field "Informed Consent Date 2" displays Query with Requires Response
	And I verify Field "Numeric Field 2" displays Query with Requires Response
	And I take screenshot
	And I enter data in CRF
	    |Field                   |Data        |
...
And I save CRF
	...
	And I verify Field "Assessment Date 1" displays Query with Requires Response
	And I verify Field "Assessment Date 2" displays Query with Requires Response
	And I verify Field "Numeric Field 1" displays Query with Requires Response
	And I verify Field "Numeric Field 2" displays Query with Requires Response
	And I take screenshot
	And I answer the Query on Field "Assessment Date 1,Assessment Date 2,Numeric Field 1,Numeric Field 2"
	And I save CRF
	And I take screenshot
	And I enter data in CRF
	    |Field             |Data        |
	...
	And I take screenshot
    When I run SQL Script "Query Logging Script.sql"  #Q
    Then I shoud see SQL result 
      |ProjectName        |SiteNumber  |SiteName          |Environment |SubjectName  |CheckActionInstanceName     |CheckActionInstanceDataPageName |CheckActionRecordPosition |CheckActionFieldName |CheckActionFieldData |TriggerFieldInstanceName |TriggerFieldInstanceDatapageName |TriggerFieldRecordPosition |TriggerFieldName |TriggerFieldData |EditCheckName                                          |MarkingGroupName |QueryMessage                                                    |EventTime  |
	...
	And I enter data in CRF
	    ...
	    |Numeric Field 2   |77          |
	And I save CRF	
	And I verify queries did fire on "Assessment Date 1", "Assessment Date 2", "Numeric Field 1" and "Numeric Field 2" fields
	And I take screenshot
    When I run SQL Script "Query Logging Script.sql"  
    Then I shoud NOT see SQL result 
      |ProjectName        |SiteNumber  |SiteName          |Environment |SubjectName  |CheckActionInstanceName     |CheckActionInstanceDataPageName |CheckActionRecordPosition |CheckActionFieldName |CheckActionFieldData |TriggerFieldInstanceName |TriggerFieldInstanceDatapageName |TriggerFieldRecordPosition |TriggerFieldName |TriggerFieldData |EditCheckName                                          |MarkingGroupName |QueryMessage                                                    |EventTime  |
