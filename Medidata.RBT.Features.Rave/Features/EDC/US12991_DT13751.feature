...
@PB_12991_01
@Draft	
Scenario: PB_12991_01, As a Rave Administrator, when I am logged into Rave, and my connection to the web, application or reporting server is lost, the core service will try and reconnect itself automatically until the connection is restored.
