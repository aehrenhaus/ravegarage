...
Scenario: PB_2.2.1 Verifies query firing between cross folders with no require response and no require manual close. Cross Folders: Standard form to log form, Folder "Screening" enter and save data on form "Informed Consent", Folder "Week 1" enter and save data on form "Concomitant Medications". 			  
	...
	And I open log line 1
	And I verify Query with message "'Date Informed Consent Signed' can not be greater than Start Date." without Requires Response is displayed on Field "Start Date"
...
Folder "Screening" enter and save data on forms "Concomitant Medications" and "Adverse Events"
	...
	And I verify Query with message "Date is Less Than Date on the first log form." without Requires Response is displayed on Field "End Date"
...
Scenario: PB_2.4.2 
    ...
    Then I should not see the logging data for queries 
      ...
      | Edit Check Study 3 | 20001      | Edit Check Site 2 | PROD        | sub204      | Screening               | Concomitant Medications         | 1                         | Original Axis Number | 100                  | Screening                | Concomitant Medications          | 1                          | Numeric Field 1     | 100              | *Is Greater Than or Equal To Open Query Log Cross Form | Marking Group 1  | 'Current Distribution Number' is greater than or Equal to 'Current Axis Number' on Log. | {DateTime} |
...
Scenario: PB_2.4.4
    ...
    Then I should not see the logging data for queries 
      ...
      | Edit Check Study 3 | 20001      | Edit Check Site 2 | PROD        | sub204      | Screening               | Concomitant Medications         | 2                         | Original Axis Number | 200                  | Screening                | Concomitant Medications          | 2                          | Numeric Field 1     | 200              | *Is Greater Than or Equal To Open Query Log Cross Form | Marking Group 1  | 'Current Distribution Number' is greater than or Equal to 'Current Axis Number' on Log. | {DateTime} |
...
And I save the CRF page
	    ...
	    | Numeric Field 1     | 100         |
	    | Current Axis Number | 101         |
	And I verify Query with message "" without Requires Response is displayed on Field ""
	And I verify Query with message "" without Requires Response is displayed on Field ""
	...
	And I cancel the Query "{message}" on Field "{fieldName}"
	And I cancel the Query "{message}" on Field "{fieldName}"
	...
	And I enter data in CRF
		...
		| Current Axis Number | 101         |
	And I save the CRF page
	And I verify Query with message "" is displayed on Field ""
    And I verify Query with message "" is displayed on Field ""
