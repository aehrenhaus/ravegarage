Feature: US13002_DT13919
	As a Rave user
	When I enter data into a field on a log form that has a Dynamic Search List
	And I click the drop-down list to display matching results
	Then matching results are displayed within 3 seconds
...
Scenario: @PB_US13002_DT13919_01 As a Study Coordinator, when I enter data into a Dynamic Search List field on a log form, and I click the drop-down list to see matching results, matching results are displayed within 3 seconds.
	...
	And I enter data in CRF
		...
		| Adverse Event Text Name (CTCAE v4.0) | Intraoperative ear injury | dynamic search list |
#Need new Step Def
	And I click the drop-down arrow for field "Adverse Event Grade"
#Need new Step Def
	Then I should see results in "Adverse Event Grade" within 3 seconds
...
@Draft
Scenario: @PB_US13002_DT13919_02 As a Study Coordinator, when I edit data into a Dynamic Search List field on a log form, and I click the drop-down list to see matching results, matching results are displayed within 3 seconds.
...
#Need new Step Def
	...
	And I add a new log line
		| Field                                | Data                           | Control Type        |
		| Adverse Event Text Name (CTCAE v4.0) | Wolff-Parkinson-White syndrome | dynamic search list |
#Need new Step Def
	And I click the drop-down arrow for field "Adverse Event Grade"
#Need new Step Def
	Then I should see results in "Adverse Event Grade" within 3 seconds 
	...
	And I enter data in CRF
		| Field                                | Data               | Control Type        |
		| Adverse Event Text Name (CTCAE v4.0) | Growth accelerated | dynamic search list |
#Need new Step Def
	And I click the drop-down arrow for field "Adverse Event Grade"
#Need new Step Def
	Then I should see results in "Adverse Event Grade" within 3 seconds
