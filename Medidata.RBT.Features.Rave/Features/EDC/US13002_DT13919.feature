...
Background:
	...
	# And Draft "<Draft1>" has Form "Adverse Event Form" with fields
		...
		# | TOXXX     | TOXXX     | 10          | CTCAE_403_TERM  | Dropdown           | Adverse Event Text Name (CTCAE v4.0)                                      | True  | 10021143,10003658,10003598,10061229,10035742,10011224,10037383,10008496,10017076 |
		...
		# | TOX_RLXX  | TOX_RLXX  | 1           | TOX_RL          | Dropdown           | CTC Adverse Event Attribution Scale                                       | True  |                                                                                  |
		# | AER_XX    | AER_XX    | 1           | YESNO           | RadioButton        | Has an adverse event expedited report been submitted?                     | True  |                                                                                  |
		# | OTHAE     | OTHAE     | 1           | OTHAE           | Dropdown           | Were <i>(other)</i> adverse events assessed during this reporting period? | False |                                                                                  |
