...
Scenario: Enroll 10 subjects in a study to verify that TSDV has randomized the subjects in non sequential order when the subjects are included in TSDV using the Targeted SDV Subject Include report in World Site group  level.
...
#	And I edit the Block "Architect Defined" and Subject Count "10"
	...
	And I switch to "Reports" window
	And I select link "Home"
	And I select Study "US18812_SJ (Dev)" and Site "Site 4"

#TODO: Need to investigate this function below
#	And I create 50 random Subjects with name "BBB" in Study "US18812_SJ (Dev)" in Site "Site 4"
	And I select link "Home"
	And I navigate to "Reporter"
	And I select Report "Targeted SDV Subject Management"
