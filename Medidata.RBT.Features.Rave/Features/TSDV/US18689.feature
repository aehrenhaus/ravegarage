...
Scenario: @PB_US18689_01 As a Rave user, when I select Permuted Block Randomization and I Enroll 50 subjects in study then subject assignment satisfies the specified ratio and is random for all blocks in study level.
	...
	And I create a new block plan named "US18689 (Dev) Block Plan" with Data entry Role "SUPER ROLE 1"
	...
	And I select link "Home"
	And I create 50 random Subjects with name "KKP" in Study "US18689 (Dev)" in Site "Site 1"
	And I select link "Home"
	And I navigate to "Reporter"
...
And I switch to "Reports" window
	...
	And I switch to "Reports" window
	And I select link "Home"
	And I create 50 random Subjects with name "BBC" in Study "US18689 (Dev)" in Site "Site 2"
	And I select link "Home"
	And I navigate to "Reporter"
	And I select Report "Targeted SDV Subject Management"
	And I set report parameter "Study" with table
	...
	And I switch to "Reports" window
	And I select link "Home"
	And I create 50 random Subjects with name "CCD" in Study "US18689 (Dev)" in Site "Site 3"
	And I select link "Home"
	And I navigate to "Reporter"
	And I select Report "Targeted SDV Subject Management"
	And I set report parameter "Study" with table
	...
	And I switch to "Reports" window
	And I select link "Home"
	And I create 40 random Subjects with name "KKI" in Study "US18689 (Dev)" in Site "Site 4"
	And I select link "Home"
	And I navigate to "Reporter"
	And I select Report "Targeted SDV Subject Management"
	And I set report parameter "Study" with table
