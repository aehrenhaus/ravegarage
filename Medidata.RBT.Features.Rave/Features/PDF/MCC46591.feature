@MCC-46591
Feature: Log Lines in Blank/Blank Annotated PDFs are not displayed.
...
| SUPER USER 1     | BlankPDF Study | Live: Prod  | SUPER ROLE 1    | Project Admin Default |
| MCC46591_locuser | BlankPDF Study | Live: Prod  | MCC46591_Role 1 | Project Admin Default |
...
@RR24.JAN.2013
@Draft
Scenario: Verify log form without default values in Landscape direction display all log lines on blank PDF with default PDF Configuration Profile (MCC46591PDF1).
...
Then the text should contain "Adverse Events1"
|Adverse Events1                    |
...
@RR24.JAN.2013
@Draft
Scenario: Verify log form without default values in Portrait direction display all log lines on blank PDF with default PDF Configuration Profile (MCC46591PDF1).
...
Then the text should contain "Adverse Events2"
|Adverse Events2                    |
|Were there any adverse events?     |
|Adverse Event Description          |
|Start Date                         |
...
@RR24.JAN.2013
@Draft
Scenario: Verify mixed form without default values in Landscape direction display all fields standard and log on blank PDF with default PDF Configuration Profile (MCC46591PDF1).
...
Then the text should contain "Adverse Events3"
|Adverse Events3                    |
|Were there any adverse events?     |
|Adverse Event Description          |
|Start Date                         |
...
@RR24.JAN.2013
@Draft
Scenario: Verify mixed form without default values in Portrait direction display all fields standard and log on blank PDF with default PDF Configuration Profile (MCC46591PDF1).
...
Then the text should contain "Adverse Events4"
|Adverse Events4                    |
|Were there any adverse events?     |
|Adverse Event Description          |
|Start Date                         |
...
@RR24.JAN.2013
@Draft
Scenario: Verify standard form without default values display all fields on blank PDF with default PDF Configuration Profile (MCC46591PDF1).
...
Then the text should contain "Demographics1"
|Demographics1 |
|Date of Birth |
|Ethnicity     |
|Specify race  |
...
@RR24.JAN.2013
@Draft
Scenario: Verify log form without default values in Landscape direction display all log lines on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF2).
...
@RR24.JAN.2013
@Draft
Scenario: Verify log form without default values in Portrait direction display all log lines on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF2).
...
Then I should see all log lines in the "Adverse Events2" form with annotations (talk to Seth about this step)
When I select annotations on "Adverse Events2" form
And I should take to the Annotations page for "Adverse Events2" form
Then the text should contain "Adverse Events2"
|Adverse Events2                      |
|Were there any adverse events?       |
|Adverse Event Description            |
...
@RR24.JAN.2013
@Draft
Scenario: Verify mixed form without default values in Landscape direction display all fields standard and log on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF2).
...
@RR24.JAN.2013
@Draft
Scenario: Verify mixed form without default values in Portrait direction display all fields standard and log on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF2).
...
@RR24.JAN.2013
@Draft
Scenario: Verify standard form without default values display all fields on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF2).
...
@RR24.JAN.2013
@Draft
Scenario: Verify log form without default values in Landscape direction display all log lines on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF3).
...
@RR24.JAN.2013
@Draft
Scenario: Verify log form without default values in Portrait direction display all log lines on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF3).
...
@RR24.JAN.2013
@Draft
Scenario: Verify mixed form without default values in Landscape direction display all fields standard and log on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF3).
...
@RR24.JAN.2013
@Draft
Scenario: Verify mixed form without default values in Portrait direction display all fields standard and log on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF3).
...
@RR24.JAN.2013
@Draft
Scenario: Verify standard form without default values display all fields on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF3).
...
@RR24.JAN.2013
@Draft
Scenario: Verify log form with default values in Portrait direction display all log lines with default values on blank PDF with default PDF Configuration Profile (MCC46591PDF1).
...
Then the text should contain "Medical History1"
|Medical History1       |
|Visit Date:            |
|Gender                 |
|Body System:           |
...
@RR24.JAN.2013
@Draft
Scenario: Verify log form with default values in Landscape direction display all log lines with default values on blank PDF with default PDF Configuration Profile (MCC46591PDF1).
...
Then the text should contain "Medical History2"
|Medical History2       |
|Visit Date:            |
|Gender                 |
|Body System:           |
...
@RR24.JAN.2013
@Draft
Scenario: Verify log form with default values in Portrait direction display all log lines with default values on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF2).
...
@RR24.JAN.2013
@Draft
Scenario: Verify log form with default values in Landscape direction display all log lines with default values on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF2).
...
@RR24.JAN.2013
@Draft
Scenario: Verify log form with default values in Portrait direction display all log lines with default values on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF3).
...
@RR24.JAN.2013
@Draft
Scenario: Verify log form with default values in Landscape direction display all log lines with default values on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF3).
...
@RR24.JAN.2013
@Draft
Scenario: Verify mixed form with default values in Portrait direction display all fields standard and log with default values on blank PDF with default PDF Configuration Profile (MCC46591PDF1).
...
Then the text should contain "Medical History3"
|Medical History3       |
|Visit Date:            |
|Gender                 |
|Body System:           |
...
@RR24.JAN.2013
@Draft
Scenario: Verify mixed form with default values in Landscape direction display all fields standard and log with default values on blank PDF with default PDF Configuration Profile (MCC46591PDF1).
...
Then the text should contain "Medical History4"
|Medical History4       |
|Visit Date:            |
|Gender                 |
|Body System:           |
...
@RR24.JAN.2013
@Draft
Scenario: Verify mixed form with default values in Portrait direction display all fields standard and log with default values on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF2).
...
@RR24.JAN.2013
@Draft
Scenario: Verify mixed form with default values in Landscape direction display all fields standard and log with default values on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF2).
...
@RR24.JAN.2013
@Draft
Scenario: Verify mixed form with default values in Portrait direction display all fields standard and log with default values on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF3).
...
@RR24.JAN.2013
@Draft
Scenario: Verify mixed form with default values in Landscape direction display all fields standard and log with default values on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF3).
...
@RR24.JAN.2013
@Draft
Scenario: Verify log form without default values display all log lines with localization user on blank PDF with default PDF Configuration Profile (MCC46591PDF1).
...
When I create Blank PDF
| LName                             | LProfile      | LStudy          | LRole            | LLocale            | LCRFVersion |LForm Exclusions                                                                                                                                                 |
| MCC46591BlankZb{RndNum<num28>(3)} | LMCC46591PDF1 | LBlankPDF Study | LMCC46591_Role 1 | LLocalization Test | LVersion 1  |LAdverse Events2, LAdverse Events3, LAdverse Events4, LDemographics1, LDemographics2, LMedical History1, LMedical History2, LMedical History3, LMedical History4 | 
And I take a screenshot
...
Then the text should contain "LAdverse Events1"
|LAdverse Events1                    |
...
@RR24.JAN.2013
@Draft 
Scenario: Verify mixed form without default values display all fields standard and log with localization user on blank PDF with default PDF Configuration Profile (MCC46591PDF1).
...
When I create Blank PDF
| LName                             | LProfile      | LStudy          | LRole            | LLocale            | LCRFVersion |LForm Exclusions                                                                                                                                                 |
| MCC46591BlankZc{RndNum<num29>(3)} | LMCC46591PDF1 | LBlankPDF Study | LMCC46591_Role 1 | LLocalization Test | LVersion 1  |LAdverse Events1, LAdverse Events2, LAdverse Events4, LDemographics1, LDemographics2, LMedical History1, LMedical History2, LMedical History3, LMedical History4 |
And I take a screenshot
...
Then the text should contain "LAdverse Events3"
|LAdverse Events3                    |
|LWere there any adverse events?     |
|LAdverse Event Description          |
|LStart Date                         |
...
@RR24.JAN.2013
@Draft 
Scenario: Verify standard form without default values display all fields with localization user on blank PDF with default PDF Configuration Profile (MCC46591PDF1).
...
When I create Blank PDF
| LName                             | LProfile      | LStudy          | LRole            | LLocale            | LCRFVersion |LForm Exclusions                                                                                                                                                   |
| MCC46591BlankZd{RndNum<num30>(3)} | LMCC46591PDF1 | LBlankPDF Study | LMCC46591_Role 1 | LLocalization Test | LVersion 1  |LAdverse Events1, LAdverse Events2, LAdverse Events3, LAdverse Events4, LDemographics2, LMedical History1, LMedical History2, LMedical History3, LMedical History4 |
And I take a screenshot
...
Then the text should contain "LDemographics1"
|LDemographics1 |
|LDate of Birth |
|LEthnicity     |
|LSpecify race  |
...
@RR24.JAN.2013
@Draft
Scenario: Verify standard form with default values display all fields on blank PDF with default PDF Configuration Profile (MCC46591PDF1).
...
When I create Blank PDF
| Name                              | Profile      | Study          | Role         | Locale  | CRFVersion |Form Exclusions                                                                                                                                           |
| MCC46591BlankZe{RndNum<num31>(3)} | MCC46591PDF1 | BlankPDF Study | SUPER ROLE 1 | English | Version 1  |Adverse Events1, Adverse Events2, Adverse Events3, Adverse Events4, Demographics1, Medical History1, Medical History2, Medical History3, Medical History4 |
And I take a screenshot
...
Then the text should contain "Demographics2"
|Demographics2   |
|Date of Birth   |
|Ethnicity       |
|Specify race    |
...
@RR24.JAN.2013
@Draft
Scenario: Verify standard form with default values display all fields on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF2).
...
When I create Blank PDF
| Name                              | Profile      | Study          | Role         | Locale  | CRFVersion |Form Exclusions                                                                                                                                           |
| MCC46591BlankZf{RndNum<num32>(3)} | MCC46591PDF2 | BlankPDF Study | SUPER ROLE 1 | English | Version 1  |Adverse Events1, Adverse Events2, Adverse Events3, Adverse Events4, Demographics1, Medical History1, Medical History2, Medical History3, Medical History4 |
And I take a screenshot
...
@RR24.JAN.2013
@Draft
Scenario: Verify standard form with default values display all fields on blank PDF with Annotated PDF Configuration Profile (MCC46591PDF3).
...
When I create Blank PDF
| Name                              | Profile      | Study          | Role         | Locale  | CRFVersion |Form Exclusions                                                                                                                                           |
| MCC46591BlankZg{RndNum<num33>(3)} | MCC46591PDF3 | BlankPDF Study | SUPER ROLE 1 | English | Version 1  |Adverse Events1, Adverse Events2, Adverse Events3, Adverse Events4, Demographics1, Medical History1, Medical History2, Medical History3, Medical History4 |
And I take a screenshot
