...
@Validation 
Scenario: PB_US15841_US17279_US17414_DT5899_DT14019A A blank PDF that is generated should not produce multiple pages for the default log lines. When I view the blank PDF that is generated, I should see a continuous page or set of pages for the default log lines, I should not see a new page produced for every default log line and I should not see a blank page in PDF.
...
@Validation
Scenario: PB_US15841_US17279_US17414_DT5899_DT14019B As a user when I navigate to "PDF Generator" and select "Create Blank Request" using "Annotated PDF profile" where the "Pre-Filled Values" checkbox has been checked from the "Annotations" category, then I should see all the prefilled values in one page. I should not see a blank page in PDF.
