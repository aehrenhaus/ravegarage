...
|US12607PDFA  |
Given following PDF Configuration Profile Settings exist
|Profile Name  |Annotations       |
|US12607PDFB  |Pre-Filled Values |
...
Scenario:@US12607_US19066-01B When I select all assigned forms while creating PDF with default PDF Configuration Profile, then i should see a continuous list of all records.
	...
	Then I should see continuous list of all records/loglines
	And I should see continuous list of all records/loglines on "Adverse Events1", "Adverse Events2", "Medical History1" and "Medical History2" forms
	And I take a screenshot
...
Scenario:@US12607_US19066-02B When I unselect all assigned forms while creating PDF with default PDF Configuration Profile, then i should see a page break after each individual record.
    ...
    Then I should see a page break after each individual record/logline
    And I should see a page break after each individual record/logline on "Adverse Events1", "Adverse Events2", "Medical History1" and "Medical History2" forms
    And I take a screenshot
...
Scenario:@US12607_US19066-03B When i select two forms while creating PDF with default PDF Configuration Profile, then i should see continuous list of records on selected two forms and i should see a page break after each individual record on unselected forms.
	...
	Then I should see continuous list of records/loglines
	And I should see continuous list of records/loglines on "Adverse Events2" and "Medical History2" forms
	And I take a screenshot
	And I should see a page break after each individual record/logline on "Adverse Events1" and "Medical History1" forms
	And I take a screenshot
	
@release_2012.1.0
@US12607_US19066-04B
@WIP
Scenario:@US12607_US19066-04B When i select all assigned forms while creating PDF with Pre-Filled Annotations PDF Configuration Profile, then i should see continuous list of all records and i should see all the prefilled values in one page on the forms.
	...
	And I create Data PDF
		|Name                    |Profile      |Study                      |Role          |Locale  |Display multiple log lines per page|Site Groups|Sites  |Subjects      |
		|DataPDFD{RndNum<num>(3)}|US12607PDFB  |US12607DataPDFStudy (Prod) |US12607_role1 |English |Select All                         |World      |Site_A |Sub{Var(num1)}|
	And I take a screenshot
	And I generate Data PDF "DataPDFD{Var(num)}"
	And I wait for PDF "DataPDFD{Var(num)}" to complete
	And I take a screenshot
	When I View Data PDF "DataPDFD{Var(num)}"
	Then I should see continuous list of all records/loglines
	And I should see continuous list of all records/loglines on "Adverse Events1", "Adverse Events2", "Medical History1" and "Medical History2" forms
	And I take a screenshot	
	And I should see all the prefilled values in one page on "Adverse Events1", "Adverse Events2", "Medical History1" and "Medical History2" forms
	When I click on any form on the PDF in the left side
	Then I should see the form on the right side of the PDF with Annonations
	And I take a screenshot
    When I click on the Annotations on any form on the PDF
    Then I should take to the Annotations page of the form
	And I take a screenshot
	
@release_2012.1.0
@US12607_US19066-05B
@WIP
Scenario:@US12607_US19066-05B When i unselect all assigned forms while creating PDF with Pre-Filled Annotations PDF Configuration Profile, then i should see a page break after each individual record and i should see all the prefilled values in one page on forms.
	...
	And I create Data PDF
		|Name                    |Profile      |Study                      |Role           |Locale  |Display multiple log lines per page|Site Groups|Sites  |Subjects      |
		|DataPDFE{RndNum<num>(3)}|US12607PDFB  |US12607DataPDFStudy (Prod) |US12607_role1  |English |                                   |World      |Site_A |Sub{Var(num1)}|
	And I take a screenshot
	And I generate Data PDF "DataPDFE{Var(num)}"
	And I wait for PDF "DataPDFE{Var(num)}" to complete
	And I take a screenshot
	When I View Data PDF "DataPDFE{Var(num)}"
	Then I should see a page break after each individual record/logline
	And I should see a page break after each individual record/logline on "Adverse Events1", "Adverse Events2", "Medical History1" and "Medical History2" forms
	And I take a screenshot
	And I should see all the prefilled values in one page on "Adverse Events1", "Adverse Events2", "Medical History1" and "Medical History2" forms
...
@US12607_US19066-06B
@WIP
Scenario:@US12607_US19066-06B When i select two forms while creating PDF with Pre-Filled Annotations PDF Configuration Profile, then i should see continuous list of records on selected two forms and i should see a page break after each individual record on unselected forms and i should see all the prefilled values in one page on forms.
	...
	And I create Data PDF
		|Name                    |Profile     |Study                      |Role           |Locale  |Display multiple log lines per page |Site Groups|Sites  |Subjects      |
		|DataPDFF{RndNum<num>(3)}|US12607PDFB |US12607DataPDFStudy (Prod) |US12607_role1  |English |Adverse Events1 Medical History1    |World      |Site_A |Sub{Var(num1)}|
	And I take a screenshot
	And I generate Data PDF "DataPDFF{Var(num)}"
	And I wait for PDF "DataPDFF{Var(num)}" to complete
	And I take a screenshot
	When I View Data PDF "DataPDFF{Var(num)}"
	Then I should see continuous list of records/loglines
	And I should see continuous list of records/loglines on "Adverse Events1" and "Medical History1" forms
	And I take a screenshot
	And I should see a page break after each individual record/logline on "Adverse Events2" and "Medical History2" forms
	And I take a screenshot
	And I should see all the prefilled values in one page on "Adverse Events1", "Adverse Events2", "Medical History1" and "Medical History2" forms
	When I click on any form on the PDF in the left side
	Then I should see the form on the right side of the PDF with Annonations
...
@US12607_US19066-07B
@WIP
Scenario:@US12607_US19066-07B When I select all assigned forms while creating PDF with default PDF Configuration Profile with Localization locale, then i should see a continuous list of all records with "L" locale.
	...
	Then I should see continuous list of all records/loglines with "L" locale
	And I should see continuous list of all records/loglines with "L" locale on "LAdverse Events1", "LAdverse Events2", "LMedical History1" and "LMedical History2" forms
	And I take a screenshot
	
@release_2012.1.0
@US12607_US19066-08B
@WIP
Scenario:@US12607_US19066-08B When I unselect all assigned forms while creating PDF with default PDF Configuration Profile with Localization locale, then i should see a page break after each individual record with "L" locale.
	...
	Then I should see a page break after each individual record/logline with "L" locale
	And I should see a page break after each individual record/logline with "L" locale "LAdverse Events1", "LAdverse Events2", "LMedical History1" and "LMedical History2" forms
	And I take a screenshot