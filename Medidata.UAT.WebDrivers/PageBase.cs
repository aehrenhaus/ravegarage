...
namespace Medidata.UAT.WebDrivers
{
	public class PageBase
	{
		...
		public static RemoteWebDriver OpenBrowser(string browserName = null)
		{
			...
			switch (WebDriversConfiguration.Default.BrowserName.ToLower())
			{
				case "firefox":
					if (!string.IsNullOrEmpty(WebDriversConfiguration.Default.BrowserLocation))
					{
						FirefoxProfile p = new FirefoxProfile();
						FirefoxBinary bin = new FirefoxBinary(WebDriversConfiguration.Default.BrowserLocation);
