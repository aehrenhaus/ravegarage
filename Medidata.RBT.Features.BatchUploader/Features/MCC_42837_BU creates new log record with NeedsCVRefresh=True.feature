...
Background:
	...
	SQL 2
	select * from DataPages DP 
	join Forms fr on dp.FormID = fr.FormID 
	where SubjectID = <SubjectPageid>
...
|"<SUB_INIT>"|"<SUB_NUM>"|"<BIRTHDAT>"|"<SEX>"|"<RACE>"|"<SITE>"|"<FIELD1A>"|"<FIELD1B>"|
"<FIELD3ASTD>"|"<FIELD3BLOG>"|"<FIELD3CLOG>"|"<FIELD3DSTD>"|"<LOGFIELD2A>"|"<LOGFIELD2B>"|
|<"JA0">|<"100">|<"1978 SEP 28">|<"1">|<"1">|<"666">|<"std00">|<"std20">|
<"mix0std1">|<"mix0log1">|<"mix0log2">|<"1">|<"lgfld00">|<"lgfld20">|
...
|"<SUB_INIT>"|"<SUB_NUM>"|"<BIRTHDAT>"|"<SEX>"|"<RACE>"|"<SITE>"|"<FIELD1A>"|"<FIELD1B>"|
"<FIELD3ASTD>"|"<FIELD3BLOG>"|"<FIELD3CLOG>"|"<FIELD3DSTD>"|"<LOGFIELD2A>"|"<LOGFIELD2B>"|
|<"JA1">|<"100">|<"1978SEP20">|<"1">|<"1">|<"666">|<"std10">|<"std20">|
<"mix1std1">|<"mix0log1">|<"mix0log2">|<"1">|<"lgfld10">|<"lgfld20">|
