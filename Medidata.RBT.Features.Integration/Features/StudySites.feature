...
Scenario: When a StudySite POST message gets put onto the queue, the studysite is created in Rave.
	...
	And the studysite should have the ExternalSiteId "10"
	And the studysite should have the SiteName "TestSiteName"
	And the studysite should have the SiteNumber "49878567483"
...
Scenario: When a StudySite PUT message gets put onto the queue, the studysite is updated in Rave.
	...
	And the studysite should have the ExternalStudyId "6"
	And the studysite should have the ExternalSiteId "10"
	And the studysite should have the SiteName "TestSiteNameUpdated"
	And the studysite should have the SiteNumber "49878567483updated"
