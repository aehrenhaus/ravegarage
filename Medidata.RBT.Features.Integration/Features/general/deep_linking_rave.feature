...
@IZ20.SEP.2013
@Draft  
Scenario: 2.5.1.74-123  As Internal Rave user that is logged in, I am assigned to eLearning course for a particular edc role which has a status of Completed.
             When when deep link URL, the eLearning course is not required and status should show as "Completed" for that particular
			 assigned role in Rave 
...
@IZ20.SEP.2013
@Draft  
Scenario: 2.5.1.74-124   As Internal Rave user that is not logged in, I am assigned to eLearning course for a particular edc role which has a status of Completed.
             When when deep link URL, the eLearning course is not required and status should show as "Completed" for that particular
			 assigned role in Rave 
...
@IZ20.SEP.2013
@Draft  
Scenario: 2.5.1.74-125 As Internal Rave user that is logged in, I am assigned to eLearning course for a particular edc role which has a status of Incomplete.
             When when deep link URL, the eLearning course is still required and status should show as "Incomplete" for that particular
			 assigned role in Rave 
...
@IZ20.SEP.2013
@Draft  
Scenario: 2.5.1.74-126 As Internal Rave user that is not logged in, I am assigned to eLearning course for a particular edc role which has a status of Incomplete.
             When when deep link URL, the eLearning course is still required and status should show as "Incomplete" for that particular
			 assigned role in Rave 
...
@IZ20.SEP.2013
@Draft  
Scenario: 2.5.1.74-127   As Internal Rave user that is not logged in, I am assigned to eLearning course for a particular edc role which has a status of Incomplete.
             When when deep link URL, the eLearning course is still required and status should show as "Incomplete" for that particular
...
@IZ20.SEP.2013
@Draft  
Scenario: 2.5.1.74-128 As Internal Rave user that is logged in, I am assigned to eLearning course for a particular edc role which has a status of Incomplete.
             When when deep link URL, the eLearning course is still required and status should show as "Incomplete" for that particular
			 assigned role in Rave and eLearning course not required for the second role,user should be able to access Rave with the second role.
...
@IZ20.SEP.2013
@Draft  
Scenario: 2.5.1.74-129 As Internal Rave user that is logged in, I am assigned to eLearning course for a particular edc role which has a status of Not Started.
             When when deep link URL, the eLearning course is still required and status should show as "Not Started" for that particular
			 assigned role in Rave 
...
@IZ20.SEP.2013
@Draft  
Scenario: 2.5.1.74-130 As Internal Rave user that is not logged in,I am assigned to eLearning course for a particular edc role which has a status of Not Started.
             When when deep link URL, the eLearning course is still required and status should show as "Not Started" for that particular
			 assigned role in Rave 
