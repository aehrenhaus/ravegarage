...
namespace Medidata.RBT
{
	...
	public class WebTestContext
	{
		...
		public FileInfo LastDownloadFile
		{
			get
			{
		...
		/// <returns></returns>
		public RemoteWebDriver OpenBrowser(string browserName = null)
		{
		...
		public void ClearDownloads()
        {
			try
			{
				Directory.Delete(RBTConfiguration.Default.DownloadPath, true);
