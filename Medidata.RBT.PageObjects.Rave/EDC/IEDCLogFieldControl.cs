...
namespace Medidata.RBT.PageObjects.Rave
{
    ...
    {
        /// <summary>
        /// Determines whether or not a high level Rave EDC element, defined by ControlTypeInformation.ControlType enum,
        ...
        /// <returns></returns>
        bool IsElementFocused(ControlTypeInformation.ControlType type, int position);
        /// <summary>
        /// Sets focus to a high level Rave EDC element, defined by ControlTypeInformation.ControlType enum.
        /// An EDC field can be composed of many elements so it is necessary to also specify the ordinal of the 
        /// type in question.
        /// </summary>
        /// <param name="type">High level Rave element type</param>
        /// <param name="position">The ordinal of the element in the composite field</param>
        void FocusElement(ControlTypeInformation.ControlType type, int position);
    }
}
