...
namespace Medidata.RBT.PageObjects.Rave.SeedableObjects
{
		...
		UniquedSeedableObject
	{
        ...
        {
            base.Seed();
            CreateProjectCoderRegistration();

            CoderWorkFlow cwf = FetchOrCreateDefaultWorkFlow();
            FetchOrCreateDefaultWorkFlowData(cwf, "IsApprovalRequired", "False");
            FetchOrCreateDefaultWorkFlowData(cwf, "IsAutoApproval", "True");

            CreateProjectCoderRegistrationWorkFlow(cwf);
        }
